...
for i in range(1,len(data)):
    ...
    if dataParsed["Response"] != "False":
        totalnumoffilms+=1
        cur.execute("""INSERT INTO movies (title, description, year, rated, runtime) VALUES (%s, %s);""", (dataParsed["Title"],dataParsed["Plot"],dataParsed["Year"],dataParsed["Rated"], dataParsed["Runtime"]))
